...
* помнить, что есть множество других классных принципов, которые не попали в SOLID только потому, что начинались на другие буквы - GRASP, YAGNI, DRY, мой любимый [Закон Деметры](https://en.wikipedia.org/wiki/Law_of_Demeter) и т.д.
