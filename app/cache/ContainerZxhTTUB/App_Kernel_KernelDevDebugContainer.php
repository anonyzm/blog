 ...
 */
class App_Kernel_KernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'ParsedownExtra' => 'getParsedownExtraService',
        ];
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.debug' => true,
            'kernel.logs_dir' => (\dirname(__DIR__, 2).'/logs'),
            'kernel.bundles' => [
            ...
            'kernel.container_class' => 'App_Kernel_KernelDevDebugContainer',
        ];
    }
}
