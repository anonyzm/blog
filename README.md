...
- **Cloudflare:** Автоматическая очистка кэша после деплоя
...
- `CLOUDFLARE_API_TOKEN` - API токен Cloudflare с правами на очистку кэша

#### Переменные:
- `TEST_COVERAGE_THRESHOLD` - минимальный порог покрытия кода (по умолчанию: 80)
